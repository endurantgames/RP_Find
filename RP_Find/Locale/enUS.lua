...
L["Button Toolbar Scan"                    ] = "Scan";
L["Button Toolbar Search"                  ] = "Search";
L["Button Toolbar Send Ad"                 ] = "Send Ad";
L["Button Toolbar Send LFG"                ] = "Send LFG";

L["Button Toolbar Tools Tooltip"           ] = "Tools";
L["Button Toolbar Check LFG Tooltip"       ] = "Check LFG";
L["Button Toolbar Database Tooltip"        ] = "Database";
L["Button Toolbar Edit Ad Tooltip"         ] = "Edit Ad";
L["Button Toolbar Preview Ad Tooltip"      ] = "Preview Ad";
L["Button Toolbar Prune Tooltip"           ] = "Prune";
L["Button Toolbar Read Ads Tooltip"        ] = "Read Ads";
L["Button Toolbar Scan Tooltip"            ] = "Scan";
L["Button Toolbar Search Tooltip"          ] = "Search";
L["Button Toolbar Send Ad Tooltip"         ] = "Send Ad";
L["Button Toolbar Send LFG Tooltip"        ] = "Send LFG";
