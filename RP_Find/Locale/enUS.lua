...
L["Button Clear Ad Tooltip 1"              ] = "Click to clear your ad.";
L["Button Clear Ad Tooltip 2"              ] = "Warning: This can't be undone.";
...
L["Button Preview Ad Tooltip"              ] = "Preview your ad.";
L["Button Preview Ad"                      ] = "Preview Ad";
L["Button Right-Click"                     ] = "Right-Click";
L["Button Scan Now Tooltip 1"              ] = "This will send a (silent) map scan request to all players in %s who use TRP3.";
L["Button Scan Now Tooltip 2"              ] = "Players whose TRP3 addons respond to the map scan request will be added to your personal database.";
L["Button Scan Now"                        ] = "Scan Now";
L["Button Scan Results Tooltip 1"          ] = "Click this button to switch to the database tab.";
L["Button Scan Results Tooltip 2"          ] = "Your filter will be set to show players who responded to your las map scan.";
L["Button Scan Results"                    ] = "Scan Results";
L["Button Search"                          ] = "Search";
L["Button Send Ad Tooltip 1"               ] = "Click this to send your ad.";
L["Button Send Ad Tooltip 2"               ] = "You can send an ad only once every minute.";
...
L["Button Toolbar Autosend Start Tooltip"  ] = "Send your LFRP ad now, and then autosend every hour.";
...
L["Config Lighten Colors Tooltip"          ] = "Some players' RP names and classes contain color codes that are too dark to read. Check this box to automatically lighten the colors.";
L["Config Lighten Colors"                  ] = "Lighten Colors";
...
L["Config Name Column Addon Tooltip"       ] = "Display the character's RP addon in the tooltip.";
L["Config Name Column Addon"               ] = "Addon";
L["Config Name Column Age Tooltip"         ] = "Display the character's age in the tooltip.";
L["Config Name Column Age"                 ] = "Age";
L["Config Name Column Class Tooltip"       ] = "Display the character's class in the tooltip.";
L["Config Name Column Class"               ] = "Class";
L["Config Name Column Currently Tooltip"   ] = "Display the character's currently in the tooltip.";
L["Config Name Column Currently"           ] = "Currently";
L["Config Name Column Height Tooltip"      ] = "Display the character's height in the tooltip.";
L["Config Name Column Height"              ] = "Height";
L["Config Name Column Icon Tooltip"        ] = "Display the character's icon in the tooltip.";
L["Config Name Column Icon"                ] = "Icon";
L["Config Name Column OOC Info Tooltip"    ] = "Display the character's OOC info in the tooltip.";
L["Config Version Check"                   ] = "Version Check";
L["Config Name Column OOC Info"            ] = "OOC Info";
L["Config Name Column Pronouns Tooltip"    ] = "Display the character's pronouns in the tooltip.";
L["Config Name Column Pronouns"            ] = "Pronouns";
L["Config Name Column Race Tooltip"        ] = "Display the character's race in the tooltip.";
L["Config Name Column Race"                ] = "Race";
L["Config Name Column Status Tooltip"      ] = "Display the character's IC/OOC status in the tooltip.";
L["Config Name Column Status"              ] = "Status";
L["Config Name Column Title Tooltip"       ] = "Display the character's title in the tooltip.";
L["Config Name Column Title"               ] = "Title";
L["Config Name Column Tooltip"             ] = "Name Column Tooltip";
L["Config Name Column Trial Tooltip"       ] = "Display the character's trial status in the tooltip.";
L["Config Name Column Trial"               ] = "Trial";
L["Config Name Column Weight Tooltip"      ] = "Display the character's weight in the tooltip.";
L["Config Name Column Weight"              ] = "Weight";
L["Config Name Column Zone Tooltip"        ] = "Display the character's current (or most recent) zone in the tooltip.";
L["Config Name Column Zone"                ] = "Zone";
...
L["Config Version Check Tooltip"           ] = "Notify whenever there's a new version of " .. addOnName .. " available.";
...
L["Field Zone to Scan Tooltip"             ] = "Select the zone that you wish to send a TRP3 map scan request to.";
...
L["Filter Flags Column Not Empty"          ] = "Flags Column Not Empty";
...
L["Format Finder Title Ads"                ] = addOnTitle .. " - Your Ad";
...
L["Format Unable To Send Ping"             ] = "Unable to send profile request to %s.";
...
L["Info Height Weight"                     ] = "Height and Weight";
...
L["Info User ID"                           ] = "User ID (Name-Server)";
...
L["Pattern Walkups Welcome"                ] = "walk%-? ?ups?";
...
L["Popup Send Invite Confirm"              ] = "You clicked the button to send a group invitation to %s. Are you sure this is what you want to do?";
L["Notify Invite Not Sent"                 ] = "Party invite cancelled.";
L["Confirm All Invites"                    ] = "Confirm All Invites";
L["Confirm No Invites"                     ] = "Don't Confirm Invites";
L["Confirm Only Non-Friends"               ] = "Don't Confirm If Friends";
L["Config Confirm Invites"                 ] = "Confirm Group Invites";
L["Config Confirm Invites Tooltip"         ] = "Choose whether you are asked to confirm sending a party/raid invite, or if it just happens when you click 'Invite'.";
...
L["Subzone Gates of Ironforge"             ] = "Gates of Ironforge";
L["Subzone Goldshire"                      ] = "Goldshire";                -- Elwynn Forest
L["Subzone Hall of Explorers"              ] = "Hall of Explorers";
...
L["Subzone The Commons"                    ] = "The Commons";
L["Subzone The Drag"                       ] = "The Drag";                 -- Orgrimmar
L["Subzone The Dwarven District"           ] = "The Dwarven District";     -- Stormwind
L["Subzone The Forlorn Cavern"             ] = "The Forlorn Cavern";
L["Subzone The Great Forge"                ] = "The Great Forge";
L["Subzone The Mage Quarter"               ] = "The Mage Quarter";         -- Stormwind
L["Subzone The Military Ward"              ] = "The Military Ward";
L["Subzone The Mystic Ward"                ] = "The Mystic Ward";
L["Subzone The Royal Exchange"             ] = "The Royal Exchange";       -- Silvermoon City
L["Subzone Tinkertown"                     ] = "Tinkertown";
...
L["Tooltip Text Close Profile Selector"    ] = "Close this window without changing the active profile.";
L["Tooltip Text Current Profile"           ] = "Click to change the current profile.";
L["Tooltip Text Send Ad Timer"             ] = "This timer shows how long until you can send your next ad.";
L["Tooltip Text Set Active Profile"        ] = "Click to set this as the active profile.";
L["Tooltip Title Close Profile Selector"   ] = "Close";
L["Tooltip Title Current Profile"          ] = "Current Profile";
L["Tooltip Title Send Ad Timer"            ] = "Send Ad Timer";
L["Trial Status"                           ] = "Trial Status";
