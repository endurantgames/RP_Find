...
L["Button Delete DB Now"               ] = "Delete Database Now";
L["Button Test Notify Tooltip"         ] = "Send yourself a test notification.";
L["Button Test Notify"                 ] = "Test Your Notifications";
...
L["Config Notify Method"               ] = "Notification Method";
L["Config Notify Sound Tooltip"        ] = "Choose a sound to play when a notification is sent.";
L["Config Notify Sound"                ] = "Notification Sound";
...
L["Button Smart Prune Database"        ] = "Prune Database Now.";
...
L["Notify Test Chat"                   ] = "This is a notification in your chat window.";
L["Notify Test Toast"                  ] = "This is a notification toast.";
...
L["Sound Silent Trigger"               ] = "Silent Trigger";
L["Sound Store Purchase"               ] = "|cff00ffff(none)|r";
...
L["Warning High Memory GB"             ] = "\n\n" .. col.red("Warning:") .. " This is an " .. col.red("extremely") .. " high amount of memory. You should " ..  col.blue("Delete Database Now") .. ".";
L["Warning High Memory MB"             ] = "\n\n" .. col.yellow("Warning:") .. " This is a high amount, and you should consider either setting the option to " .. col.blue("Delete Database on Login") .. ", or " .. col.blue("Delete Database Now") .. ".";
